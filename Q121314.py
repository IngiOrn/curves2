...
market = pd.DataFrame({'SwapRate': np.array([0.0036, 0.0052, 0.0093, 0.0121, 0.0146, 0.0166, 0.0184, 0.0199, 0.0213, 0.0221, 0.0263, 0.0273, 0.0271]),
...
def building_curve(instruments, times, spotday):
    ...
    D = dict(zip(total,discount_curve))
    return D

building_curve(list_of_instruments,total,spotday)
